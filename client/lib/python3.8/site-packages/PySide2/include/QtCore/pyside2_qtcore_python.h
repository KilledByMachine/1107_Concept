...
enum : int {
    ...
    SBK_QHISTORYSTATE_IDX                                    = 145,
    SBK_QHISTORYSTATE_HISTORYTYPE_IDX                        = 146,
    SBK_QIODEVICE_IDX                                        = 147,
    SBK_QIODEVICE_OPENMODEFLAG_IDX                           = 148,
    SBK_QFLAGS_QIODEVICE_OPENMODEFLAG_IDX                    = 107,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 149,
    SBK_QITEMSELECTION_IDX                                   = 150,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 150,
    ...
    SBK_QJSONDOCUMENT_DATAVALIDATION_IDX                     = 156,
    ...
    SBK_QLIBRARYINFO_IDX                                     = 162,
    SBK_QLIBRARYINFO_LIBRARYLOCATION_IDX                     = 163,
    SBK_QLINE_IDX                                            = 164,
    SBK_QLINEF_IDX                                           = 165,
    SBK_QLINEF_INTERSECTTYPE_IDX                             = 166,
    SBK_QLOCALE_IDX                                          = 167,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 172,
    SBK_QLOCALE_SCRIPT_IDX                                   = 420,
    SBK_QLOCALE_COUNTRY_IDX                                  = 168,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 173,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 171,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 174,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 110,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 170,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 418,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 169,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 109,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 419,
    SBK_QLOCKFILE_IDX                                        = 175,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 176,
    SBK_QMARGINS_IDX                                         = 177,
    SBK_QMARGINSF_IDX                                        = 178,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 179,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 180,
    SBK_QMETACLASSINFO_IDX                                   = 181,
    SBK_QMETAENUM_IDX                                        = 182,
    SBK_QMETAMETHOD_IDX                                      = 183,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 184,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 185,
    SBK_QMETAOBJECT_IDX                                      = 186,
    SBK_QMETAOBJECT_CALL_IDX                                 = 187,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 188,
    SBK_QMETAPROPERTY_IDX                                    = 189,
    ...
    SBK_QMUTEX_IDX                                           = 195,
    SBK_QMUTEX_RECURSIONMODE_IDX                             = 196,
    SBK_QMUTEXLOCKER_IDX                                     = 197,
    SBK_QOBJECT_IDX                                          = 198,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 199,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 200,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 201,
    SBK_QPAUSEANIMATION_IDX                                  = 202,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 203,
    SBK_QPLUGINLOADER_IDX                                    = 204,
    SBK_QPOINT_IDX                                           = 205,
    SBK_QPOINTF_IDX                                          = 206,
    SBK_QPROCESS_IDX                                         = 207,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 212,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 213,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 210,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 211,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 209,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 208,
    SBK_QPROCESSENVIRONMENT_IDX                              = 214,
    SBK_QPROPERTYANIMATION_IDX                               = 215,
    SBK_QRANDOMGENERATOR_IDX                                 = 216,
    SBK_QRANDOMGENERATOR64_IDX                               = 217,
    SBK_QREADLOCKER_IDX                                      = 218,
    SBK_QREADWRITELOCK_IDX                                   = 219,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 220,
    SBK_QRECT_IDX                                            = 221,
    SBK_QRECTF_IDX                                           = 222,
    SBK_QRECURSIVEMUTEX_IDX                                  = 223,
    SBK_QREGEXP_IDX                                          = 224,
    SBK_QREGEXP_PATTERNSYNTAX_IDX                            = 226,
    SBK_QREGEXP_CARETMODE_IDX                                = 225,
    ...
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 231,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 232,
    SBK_QRESOURCE_IDX                                        = 233,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 234,
    SBK_QRUNNABLE_IDX                                        = 235,
    SBK_QSAVEFILE_IDX                                        = 236,
    SBK_QSEMAPHORE_IDX                                       = 237,
    SBK_QSEMAPHORERELEASER_IDX                               = 238,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 239,
    SBK_QSETTINGS_IDX                                        = 240,
    SBK_QSETTINGS_STATUS_IDX                                 = 243,
    SBK_QSETTINGS_FORMAT_IDX                                 = 241,
    SBK_QSETTINGS_SCOPE_IDX                                  = 242,
    SBK_QSIGNALBLOCKER_IDX                                   = 244,
    SBK_QSIGNALMAPPER_IDX                                    = 245,
    SBK_QSIGNALTRANSITION_IDX                                = 246,
    SBK_QSIZE_IDX                                            = 247,
    SBK_QSIZEF_IDX                                           = 248,
    ...
    SBK_QSTATE_IDX                                           = 256,
    SBK_QSTATE_CHILDMODE_IDX                                 = 257,
    SBK_QSTATE_RESTOREPOLICY_IDX                             = 258,
    SBK_QSTATEMACHINE_IDX                                    = 259,
    SBK_QSTATEMACHINE_EVENTPRIORITY_IDX                      = 261,
    SBK_QSTATEMACHINE_ERROR_IDX                              = 260,
    SBK_QSTATEMACHINE_SIGNALEVENT_IDX                        = 262,
    SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX                       = 263,
    SBK_QSTORAGEINFO_IDX                                     = 264,
    SBK_QSTRINGLISTMODEL_IDX                                 = 265,
    SBK_QSYSINFO_IDX                                         = 266,
    SBK_QSYSINFO_SIZES_IDX                                   = 268,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 267,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 269,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 270,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 271,
    SBK_QTEMPORARYDIR_IDX                                    = 272,
    SBK_QTEMPORARYFILE_IDX                                   = 273,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 274,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 276,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 275,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 114,
    SBK_QTEXTCODEC_IDX                                       = 277,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 278,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 115,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 279,
    SBK_QTEXTDECODER_IDX                                     = 280,
    SBK_QTEXTENCODER_IDX                                     = 281,
    ...
    SBK_QTIMELINE_STATE_IDX                                  = 295,
    SBK_QTIMELINE_DIRECTION_IDX                              = 294,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 293,
    SBK_QTIMEZONE_IDX                                        = 296,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 299,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 297,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 298,
    SBK_QTIMER_IDX                                           = 300,
    SBK_QTIMEREVENT_IDX                                      = 301,
    SBK_QTRANSLATOR_IDX                                      = 302,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 303,
    SBK_QURL_IDX                                             = 304,
    SBK_QURL_PARSINGMODE_IDX                                 = 306,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 307,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 305,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 117,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 308,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 119,
    SBK_QURLQUERY_IDX                                        = 309,
    SBK_QUUID_IDX                                            = 310,
    SBK_QUUID_VARIANT_IDX                                    = 312,
    SBK_QUUID_VERSION_IDX                                    = 313,
    SBK_QUUID_STRINGFORMAT_IDX                               = 311,
    SBK_QVARIANTANIMATION_IDX                                = 314,
    SBK_QVERSIONNUMBER_IDX                                   = 315,
    SBK_QWAITCONDITION_IDX                                   = 316,
    SBK_QWRITELOCKER_IDX                                     = 317,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 318,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 319,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 319,
